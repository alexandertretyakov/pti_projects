...
*** для общего развития\расширять кругозор\иметь общее представление
...
CSS Grid
    ...
    CSS Grid верстка простыми словами, часть 1. Базовая терминология
    Михаил Непомнящий

Что происходит...
    https://www.youtube.com/watch?v=OjBcOQ_ynJo
    Что происходит в браузере после того, как пользователь ввёл адрес в адресную строку / Катя Танькова
    MinskJS
...
FE Roadmap
    https://www.youtube.com/watch?v=eYrdtDOq5Lg
    Роудмап по фронтенду: что я не знал?
    Лёша Корепанов

    https://www.youtube.com/watch?v=fcyMIizIAWw
    Дорожная карта Фронтенд разработчика
    Михаил Непомнящий

    https://www.youtube.com/watch?v=1WRJKgwlX9w
    Frontend Roadmap 2024 | Что должен учить фронтенд-разработчик в 2024 году
    Александр Ламков — Friendly Frontend

    https://www.youtube.com/watch?v=t5zkYgaEN0E
    Что должен знать JUNIOR Фронтенд Разработчик? ROADMAP: как стать фронтенд разработчиком в 2025
    Pomazkov JS

    https://www.youtube.com/watch?v=DhleEgRmWF8
    Самый БЫСТРЫЙ путь до работы Frontend. Frontend Roadmap 2025
    Владилен Минин
...
Шаблонизатор Pug/Jade
    https://www.youtube.com/watch?v=ZLMoyAHNZZQ&list=PLIMbZPmmhFauH0nOz7smU9r_jQGBV2umv
    Шаблонизатор PUG/JADE для HTML | Урок #1. Введение
    beONmax

WordPress
    https://www.youtube.com/watch?v=WjsrNZCUoW4
    Первое знакомство с админкой WordPress. Практический вебинар от TemplateMonster
    TemplateMonsterRu

    https://www.youtube.com/watch?v=ArzLw8ikaE0
    Основы WordPress: админка, настройки
    SpeedPlus
...
Promise
    https://www.youtube.com/watch?v=83vNg357dBM
...
Unit тестирование
    ...
    https://www.youtube.com/watch?v=dhLCXsDd6bo
...
Сборщики: Gulp, Webpack, Grunt
    ...
    https://www.youtube.com/watch?v=DW28sSQxBO8
    Изучение WEBPACK за час в одном видео! Настройка и работа с Webpack
    Гоша Дударь

    https://www.youtube.com/watch?v=uPk6lQoTThE
    Gulp 1: Что такое Gulp? Сравнение с Grunt и Webpack
    JavaScript.ru

Markdown
    https://www.youtube.com/watch?v=jPKi2Addbxw
    Markdown - что за язык и как им пользоваться
    Михаил Непомнящий

    https://www.youtube.com/watch?v=4ozbpsaKvGY
    Все должны знать этот язык разметки. Markdown
    Миша Ларченко

JSDoc
    https://www.youtube.com/watch?v=2l1mcp2mi0A
    JSDoc basics
    Iurii Katkov

Линтеры: ESLint, Stylelint и Prettier
    https://www.youtube.com/watch?v=wqON0YQkZ6o
    JavaScript. Урок 4. Настройка ESLint
    LiveCoder

    https://www.youtube.com/watch?v=LcvMXUxOOcA
    ...
    https://www.youtube.com/watch?v=lTeza7Vxo8c
    Совместная работа Prettier и ESLint для качественной разработки
    Михаил Непомнящий

    https://www.youtube.com/watch?v=_9RcU11mLc4
    Линтер для стилей Stylelint
    Михаил Непомнящий

    https://www.youtube.com/watch?v=3J38L01ym_w
    007 Настройка stylelint
    Web Programming

    https://www.youtube.com/watch?v=j9E0ZRbPW_c
    Зачем eslint, husky, stylelint, prettier в проекте
    Andrey Kudinov

    https://www.youtube.com/watch?v=mb89pnW49l8
...
CI/CD
    ...
    https://www.youtube.com/watch?v=2UWjfLmuJwM
    Что такое CI/CD? Простыми словами про ci cd
    Daria Shatova
    ...
    https://www.youtube.com/watch?v=noXnxdNSp4A
...
PHP
    https://www.youtube.com/watch?v=GfHSbgyHN_I&list=PLDyJYA6aTY1m5zGQVcEYIoSFz2GD8u7cC
...
CSS in JS
    https://www.youtube.com/watch?v=B4-jB_kYJT0
    CSS in JS или самая противоречивая техника стилизации веба
    Evrone Development

    https://www.youtube.com/watch?v=g9kyXOygOhY
    CSS in JS. Стилизация на React & Emotion
    Road to Senior
...
Библиотеки React компонентов: Material UI & Chakra UI
    https://www.youtube.com/watch?v=OZ_FUaV_xbg
...
Storybook
    https://www.youtube.com/watch?v=uMKFBg1BZWs
    Storybook - Быстрый курс по работе и тестированию с React
    PurpleSchool | Anton Larichev

Vue
    https://www.youtube.com/watch?v=6wYu4_6hcDY
    Vue.js. Полный курс
    webDev

    https://www.youtube.com/watch?v=TiBCLraUFvA
    Изучение Vue JS за час в одном видео! Разработка приложения на Vue
    Гоша Дударь

Angular
    https://www.youtube.com/watch?v=u1VCxpvDgsk&list=PL0lO_mIqDDFX2CXg7tZvmsY48-R5UvQ1V
...
Docker
    ...
    https://www.youtube.com/watch?v=aZTL2zRmOnA
    Что такое Docker?
    Merion Academy
...
Антихайп
    ...
    https://www.youtube.com/watch?v=jPbqeSSDuug
