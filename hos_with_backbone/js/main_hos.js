var Whores = Backbone.Collection.extend({ //Коллекция
    initialize: function() {
        this.reset(this.getModelsFromStorage()); // reset - Меняет полностью коллекцию
...
var ListView = Backbone.View.extend({
    ...
    initialize: function() {
        this.listenTo(this.collection, 'all', function() { // listenTo() подписка на события
            this.renderWhores();
        });
    ...
    events: { //Объект events - Подписка на события
